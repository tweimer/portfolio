...
public final class DataSeries
{
    ...
    public enum Type
    {
        ...
        CLIENT_FILTER("ClientFilter", i -> ((ClientFilterMenu.Item) i).getUUIDs().replace(",", "")), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        CLIENT_FILTER_PRETAX("ClientFilter-PreTax", i -> ((ClientFilterMenu.Item) i).getUUIDs().replace(",", "")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
